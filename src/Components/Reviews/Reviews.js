...
const Reviews = () => {
    ...
    return (
        <>
            ...
            <div className='m-20 border-spacing-5'>
                <form onSubmit={handleAddUser}>
                    <input className='bg-primary mb-5 text-white' type="text" required /> <br />
                    <input className='bg-secondary text-white' type="email" required /> <br />
                    <input className='btn btn-success m-5' type="submit" value="On submit" />
                </form>
            </div>
        </>
    );
